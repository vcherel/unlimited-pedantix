...
def build_display_parts(session_state: SessionState, word_list: List[WordInfo], source_text:str, last_guess: str, ):
...
def display_article(session_state: SessionState):
    ...
    title_html = build_display_parts(session_state, session_state.title_words, session_state.article.title, last_guess)
    text_html = build_display_parts(session_state, session_state.article_words, session_state.article.text, last_guess)
